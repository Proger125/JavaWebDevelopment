...
<c:set var="last_page" value="${PagePath.ERROR_500_PAGE}" scope="session"/>
<c:if test="${not empty sessionScope.locale}">
    <fmt:setLocale value="${sessionScope.locale}"/>
</c:if>
<fmt:setBundle basename="locale"/>
<fmt:message key="account.home" var="home"/>
<fmt:message key="error.500.header" var="error_header"/>
<fmt:message key="error.500.message" var="error_message"/>
<html>
<head>
    <title>500</title>
